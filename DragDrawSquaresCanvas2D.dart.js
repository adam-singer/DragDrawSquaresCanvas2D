...
$$.Shape = {"":
 ...
 contains$2: function(mx, my) {
  return $.leB(this.x, mx) && ($.geB($.add(this.x, this.w), mx) && ($.leB(this.y, my) && $.geB($.add(this.y, this.h), my)));
 },
 draw$1: function(ctx) {
  ctx.set$fillStyle(this.fill);
  ctx.fillRect$4(this.x, this.y, this.w, this.h);
 }
};

$$.CanvasState = {"":
 ["selectionWidth", "selectionColor", "dragoffy=", "dragoffx=", "selection=", "dragging=", "shapes?", "valid!", "height?", "width?", "canvas", "ctx"],
 super: "Object",
 draw$0: function() {
  if (this.valid !== true) {
    this.clear$0();
    ...
    var l = t1.length;
    var t2 = this.width;
    if (typeof t2 !== 'number') return this.draw$0$bailout(1, t1, l, t2, 0);
    var t3 = this.height;
    if (typeof t3 !== 'number') return this.draw$0$bailout(2, t1, l, t2, t3);
    var t4 = this.ctx;
    var i = 0;
    for (; i < l; ++i) {
      var t5 = t1.length;
      ...
      var t6 = t1[i];
      if ($.gtB(t6.get$x(), t2) || ($.gtB(t6.get$y(), t3) || ($.ltB($.add(t6.get$x(), t6.get$w()), 0) || $.ltB($.add(t6.get$y(), t6.get$h()), 0)))) continue;
      t5 = t1.length;
      if (i < 0 || i >= t5) throw $.ioore(i);
      t1[i].draw$1(t4);
    }
    if (!(this.selection == null)) {
      t4.set$strokeStyle(this.selectionColor);
      t4.set$lineWidth(this.selectionWidth);
      var mySel = this.selection;
      t4.strokeRect$4(mySel.get$x(), mySel.get$y(), mySel.get$w(), mySel.get$h());
    }
    this.valid = true;
  }
 },
 draw$0$bailout: function(state, env0, env1, env2, env3) {
  switch (state) {
    case 1:
      t1 = env0;
      l = env1;
  ...
  switch (state) {
    ...
    case 1:
    case 2:
      if (state == 1 || state == 2 || (state == 0 && this.valid !== true)) {
        switch (state) {
          case 0:
            this.clear$0();
            var t1 = this.shapes;
 ...
 CanvasState$1: function(canvas) {
  var t1 = this.canvas;
  this.width = t1.get$width();
  this.height = t1.get$height();
  this.ctx = t1.getContext$1('2d');
  this.shapes = [];
  this.dragoffx = 0;
  this.dragoffy = 0;
  $.add$1(t1.get$on().get$selectStart(), new $.anon());
  $.add$1(t1.get$on().get$mouseDown(), new $.anon0(this));
  $.add$1(t1.get$on().get$mouseMove(), new $.anon1(this));
  $.add$1(t1.get$on().get$mouseUp(), new $.anon2(this));
  $.add$1(t1.get$on().get$doubleClick(), new $.anon3(this));
...
$$._DocumentEventsImpl = {"":
 ["_ptr"],
 super: "_ElementEventsImpl",
 get$selectStart: function() {
  return this.operator$index$1('selectstart');
 },
 get$reset: function() {
...
$$.anon0 = {"":
 ...
 super: "Closure",
 $call$1: function(e) {
  var mx = e.get$offsetX();
  if (typeof mx !== 'number') return this.$call$1$bailout(1, e, mx, 0);
  var my = e.get$offsetY();
  if (typeof my !== 'number') return this.$call$1$bailout(2, mx, my, 0);
  var i = $.sub($.get$length(this.this_0.get$shapes()), 1);
  if (typeof i !== 'number') return this.$call$1$bailout(3, mx, my, i);
  for (; i >= 0; --i) {
    if ($.contains$2($.index(this.this_0.get$shapes(), i), mx, my) === true) {
      var mySel = $.index(this.this_0.get$shapes(), i);
      var t1 = mySel.get$x();
      if (typeof t1 !== 'number') throw $.iae(t1);
      t1 = mx - t1;
      this.this_0.set$dragoffx(t1);
      t1 = mySel.get$y();
      if (typeof t1 !== 'number') throw $.iae(t1);
      t1 = my - t1;
      this.this_0.set$dragoffy(t1);
      this.this_0.set$dragging(true);
      this.this_0.set$selection(mySel);
      this.this_0.set$valid(false);
      return;
    }
  }
  if (!(this.this_0.get$selection() == null)) {
    this.this_0.set$selection(null);
    this.this_0.set$valid(false);
  }
 },
  ...
  switch (state) {
    ...
    case 3:
      ...
      for (; $.geB(i, 0); i = $.sub(i, 1)) {
        if ($.contains$2($.index(this.this_0.get$shapes(), i), mx, my) === true) {
          var mySel = $.index(this.this_0.get$shapes(), i);
          var t1 = $.sub(mx, mySel.get$x());
          this.this_0.set$dragoffx(t1);
          t1 = $.sub(my, mySel.get$y());
          this.this_0.set$dragoffy(t1);
          this.this_0.set$dragging(true);
          this.this_0.set$selection(mySel);
          this.this_0.set$valid(false);
...
$$.anon1 = {"":
 ...
 super: "Closure",
 $call$1: function(e) {
  if (this.this_1.get$dragging() === true) {
    var t1 = $.sub(e.get$offsetX(), this.this_1.get$dragoffx());
    this.this_1.get$selection().set$x(t1);
    t1 = $.sub(e.get$offsetY(), this.this_1.get$dragoffy());
    this.this_1.get$selection().set$y(t1);
    this.this_1.set$valid(false);
  }
 }
};
...
$$.anon2 = {"":
 ...
 super: "Closure",
 $call$1: function(e) {
  this.this_2.set$dragging(false);
 }
};
...
$$.anon3 = {"":
 ...
 super: "Closure",
 $call$1: function(e) {
  this.this_3.addShape$1($.Shape$($.sub(e.get$offsetX(), 10), $.sub(e.get$offsetY(), 10), 20, 20, 'rgba(0,255,0,.6)'));
 }
};
...
$.CanvasState$ = function(canvas) {
  var t1 = new $.CanvasState(null, null, null, null, null, false, null, false, null, null, canvas, null);
  t1.CanvasState$1(canvas);
  return t1;
};
...
$.init = function() {
  var s = $.CanvasState$($.document().query$1('#canvas1'));
  s.addShape$1($.Shape$(40, 40, 50, 50, '#AAAAAA'));
  s.addShape$1($.Shape$(60, 140, 40, 60, 'lightskyblue'));
  s.addShape$1($.Shape$(80, 150, 60, 30, 'rgba(127, 255, 212, .5)'));
  s.addShape$1($.Shape$(125, 80, 30, 80, 'rgba(245, 222, 179, .7)'));
};
